 ...
 *     @OA\Property(property="status", type="string", example="en_ejecucion"),
 ...
 *     @OA\Property(property="status", type="string", enum={"capturado","en_analisis","aprobado","en_ejecucion","cerrado"}),
